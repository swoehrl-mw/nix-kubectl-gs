...
Example: `github:swoehrl-mw/nix-kubectl-gs/v5.7.2`
...
```json
{
    "packages": [
        "kubectl@latest",
        "github:swoehrl-mw/nix-kubectl-gs/v5.7.2"
    ]
}
```
...
pkgs.mkShellNoCC {
  packages = [
    pkgs.kubectl
    (builtins.getFlake "github:swoehrl-mw/nix-kubectl-gs/v5.7.2").packages.${builtins.currentSystem}.kubectl-gs
  ];
}
```
